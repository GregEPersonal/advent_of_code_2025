...
sorted_circuits_list = circuits_list.sort_by { |circuit| circuit.length }.reverse
final_result = sorted_circuits_list[0].length * sorted_circuits_list[1].length * sorted_circuits_list[2].length
